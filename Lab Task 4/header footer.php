...
<body style=" margin:0;">
    <div style="display:flex; justify-content: space-between; align-items: center; width: 100%; position: fixed; background: #85C429; padding: 20px 0; top: 0;">
        ...
        <span style="font-size: 25px; font-family: Sans-serif; font-weight: bold;">
            <a href="Task_A_home.php" style="color: black; text-decoration: none; padding: 15px; margin-right: 10px;">Home</a>
            <a href="Task_C_login.php" style="color: black; text-decoration: none; padding: 15px; margin-right: 10px;">Login</a>
            <a href="Task_B_registration.php" style="color: black; text-decoration: none; padding: 15px; margin-right: 10px;" >Registration</a>
        </span>
    </div>
